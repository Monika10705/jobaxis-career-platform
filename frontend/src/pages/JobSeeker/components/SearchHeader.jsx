...
const SearchHeader = ({ filters, handleFilterChange }) => {
  return <div className='bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200 border border-white/20 p-4 lg:p-8 mb-6'>
    <div className='flex flex-col gap-4 lg:gap-6'>
        ...
        <div className='flex flex-col lg:flex-row gap-3 lg:gap-4'>
            ...
            <button className='bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 lg:px-10 py-3 lg:py-2.5 rounded-xl lg:rounded-xl hover:from-blue-700 hover:to-blue-700 transition-all duration-200 font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translatey-y-0.5'>
                Search Jobs
            </button>
        </div>
    </div>
