          ...
          <div className="flex gap-6 lg:gap-8">
            ...
            <div className="hidden lg:block w-80 flex-shrink-0">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-6 sticky top-20">
                <h3 className="text-bold text-gray-900 text-xl mb-6">
                  Filter Jobs
                </h3>
                <FilterContent
                  toggleSection={toggleSection}
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-4">
                ...
                <div className="flex items-center justify-between lg:justify-end gap-4">
                  ...
                  <div className="flex items-center gap-3 lg:gap-4">
                    <div className="flex items-center border border-gray-200 rounded-xl pl-1 bg-white">
                      <button
              ...
              {/* job grid */}
              {jobs.length === 0 ? (
                <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-xl border border-white/20">
