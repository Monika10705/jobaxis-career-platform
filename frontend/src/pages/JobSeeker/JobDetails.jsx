...
const JobDetails = () => {
  ...
  const applyToJob = async () => {
    try {
      ...
      // Fetch job details after applying
          ...
          <div className="bg-white p-6 rounded-lg">
                ...
                <div className="flex items-center gap-3 mb-6">
                  {jobDetails?.company?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="h-20 w-20 object-cover rounded-xl border-4 border-white/20 shadow-lg "
                    />
                  ) : (
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex ietems-center space-x-3">
                  <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-purple-600 rounded-full"></div>
                  <span className="">About This Role</span>
                </h3>
                <div className="bg-gray-50 border border-gray-100 rounded-xl p-6">
                  <div className="text-sm text-gray700 leading-relaxed whitespace-pre-wrap">
