        ...
        <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-16">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <span className="text-xl font-bold text-gray-900">JobAxis</span>
                </div>
                ...
                <nav className="hidden md:flex items-center space-x-8">
                    <a
                        ...
                        className="text-gray-600 hover:text-gray-900 transition-colors font-medium"> Find Jobs</a>
                    <a
                        onClick={() => {
                            navigate(
                ...
                <div className="flex items-center space-x-3">
                    {isAuthenticated ? (
                        ...
                        <>
                            <a
                                href="/login"
                                className="text-gray-600 hover:text-gray-900 transition-colors font-medium px-4 py-2 rounded-lg hover:bg-gray-300"
                            >
                                Login
                            </a>
                            <a
