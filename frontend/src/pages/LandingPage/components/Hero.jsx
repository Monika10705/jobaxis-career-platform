    ...
    return (
        <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 w-32 h-32 bg-blur-100 rounded-full blur-3xl opacity-30"></div>
                <div className="absolure bottom-20 right-10 w-40 h-40 bg-purple-100 rounded-full blur-3xl opacity-30"></div>
