    ...
    <section className='py-15 bg-white relative overflow-hidden '>
      <div className='container mx-auto px-20 relative z-10'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>Whether you're looking for your next opportunity or the perfect candidate,
            we have the tools and features to make it happen.</p>
        </div>
