...
const ManageJobs = () => {
  ...
  //decide with sort icon to display based on current sort field and direction
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
              ...
              <div className='flex-1 relative'>
                ...
                <input
                  ...
                  className='block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-blue-500/20 focus:border-blue-500 outline-0 transition-all duration-200 bg-gray-50/50 placeholder-gray-400'
                />
              </div>
              ...
              <div className="sm:w-48">
                <select
                  ...
                  className="block w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 "
                >
                ...
                <div className='w-[75vw] md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100'>
                  <table className='min-w-full divide-y divide-gray-200'>
                    <thead className='bg-gradient-to-r from-gray-50 to-gray-100/50'>
                      <tr>
                        <th
                          className='px-6 py-4 text-left text-xs font-semibold text-gray600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0'
                        ...
                        <th
                          className='px-6 py-4 text-left text-xs font-semibold text-gray600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[120px] sm:min-w-0'
                        ...
                        <th
                          className='px-6 py-4 text-left text-xs font-semibold text-gray600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[130px] sm:min-w-0'
                        ...
                        <th className='px-6 py-4 text-left text-xs font-semibold text-gray600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[130px] sm:min-w-0'>
                          Actions
                        </th>
                      </tr>
                    </thead>
            ...
            <div className='mt-6 flex items-center justify-between'>
              <div className='flex-1 flex justify-between sm:hidden'>
                <button
                  ...
                  className='relative inline-flex items-center pz-4 py-2 border border gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed'
                >
                  Previous
                </button>
                <button
                  ...
                  className='ml-e relative inline-flex items-center pz-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not allowed'
                >
                  Next
                </button>
              </div>
                ...
                <div>
                  <nav className='relative z-0 inline-flex rounded-md shadow-sm -space-x-px'>
                    <button
                      ...
                      disabled={currentPage === 1}
                      className='relative inline-flex items-center px-2 py-2 roundedl-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not allowed'
                    >
                      Previous
                    </button>
