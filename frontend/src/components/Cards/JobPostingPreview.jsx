                ...
                <div className="">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-start justify-between mb-0">
                                ...
                                {user?.companyLogo ? (
                                    ...
                                    <div className="h-18 w-18 bg-gray-50 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
                    ...
                    <div className="px-0 pb-8 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-gray-50 border border border-gray-100 rounded-xl p-6">
