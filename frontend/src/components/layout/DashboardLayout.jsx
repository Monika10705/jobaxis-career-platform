...
const DashboardLayout = ({ activeMenu, children }) => {
    ...
    return <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex items-center h-16 border-b border-gray-200 pl-6">
                {!sidebarCollapsed ? (
                    <Link className="flex items-center space-x-3" to='/'>
                        ...
                        <span className="text-gray-900 font-bold text-xl">JobAxis</span>
                    </Link>
                ) : (
        ...
        {isMobile && sidebarOpen && (
            <div
                className="fixed inset-0 bg-black bg-opacity-25 z-40 backdrop-blue-sm"
        ...
        >
            ...
            <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-30">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-base font-semibold text-gray900">
                            Welcome back!
                        </h1>
